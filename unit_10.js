...
let ar6 = ["Gheorghi", "Телец", 5, 5];

function f6() {
    let div6 = document.createElement("div-6");
    let out6 = document.querySelector(".out-6");
    out6.appendChild(div6);
    div6.innerHTML = ar6;
}
...
function f7() {
    ...
    ar7[6] = "turkey";
    ar7[5] = "italy";
    let rez = document.querySelector(".out-7");
    let out2 = "";
